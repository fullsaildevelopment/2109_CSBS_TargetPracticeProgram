...
class Load:
    def __init__(self, _save_path):
        ...
        img = PIL.Image.open(r'Art/forward.png')
        resized_img = img.resize((32, 32))
        for_img = PIL.ImageTk.PhotoImage(resized_img)
        img = PIL.Image.open(r'Art/backward.png')
        resized_img = img.resize((32, 32))
        back_img = PIL.ImageTk.PhotoImage(resized_img)
        img = PIL.Image.open(r'Art/play.png')
        resized_img = img.resize((32, 32))
        self.play_img = PIL.ImageTk.PhotoImage(resized_img)
        img = PIL.Image.open(r'Art/pause.png')
        resized_img = img.resize((32, 32))
        self.pause_img = PIL.ImageTk.PhotoImage(resized_img)
